...
<template>
  <div style="background:#F9F8FC;">
    <div class="recommendBox">
      <img src="@/assets/images/nav/alive.png" />
      <div class="hotTitle">直播专区</div>
    ...
    <div class="px-[10px] pt-[9px] grid grid-cols-2 gap-[5px]">
      <Alive v-for="item in state.videoList" :item="item" :key="item.prostituteId" @click="toDetail(item)">
      </Alive>
    </div>
    <!-- </ScrollList> -->
  </div>
...
import { getAlive } from '@/service/community'
import ActualItem from '@/views/actual/components/actualItem.vue'
import Alive from '@/views/nav/components/alive.vue'
