...
<template>
    <div class="actual-page h-page overflow-x-hidden scrollbar">
        ...
        <div class="px-[10px]">
            <Actual :isClick="true" :itemdata="plainObject">
            </Actual>
...
import Actual from '@/views/reply/components/actual.vue'
...
let plainObject = JSON.parse(JSON.stringify(props.itemList));
console.log(props.itemList, plainObject, '----888-----')
...
// 加载数据
const init = async () => {
    const listData = await getProstituteList({
