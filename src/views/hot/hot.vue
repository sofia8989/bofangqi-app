...
<template>
    <div class="home-page h-page text-white ">
        <!-- 搜索框开始 -->
        <!-- <div class="flex items-center py-[10px] pl-[14px]  w-[100%] pr-[6px] justify-between sticky top-0 z-10">
            ...
            <div class="name" style="color: #000;">最热</div>
        ...
        <div class="hotSearch"> 
            <div class="hotNav">
                <div class="navName" @click="changeHot(1)">
                    <div class="name" :class="hotIndex == 1 ? 'chooseName' : 'name'">热门标签</div>
                    <div class="line" :class="hotIndex == 1 ? 'chooseLine' : 'line'"></div>
                </div>
                <div class="navName" @click="changeHot(0)">
                    <div class="name" :class="hotIndex == 0 ? 'chooseName' : 'name'">VIP视频</div>
                    <div class="line" :class="hotIndex == 0 ? 'chooseLine' : 'line'"></div>
                </div>
                <div class="navName" @click="changeHot(2)">
                    <div class="name" :class="hotIndex == 2 ? 'chooseName' : 'name'">免费视频</div>
                    <div class="line" :class="hotIndex == 2 ? 'chooseLine' : 'line'"></div>
                </div>
            </div>
            <div class="hotList">
                <!-- 热门标签 -->
                <div class="hotLabel" v-if="hotIndex == 1">
                    <div class="label" v-for="item, index in hotList" :key="index" @click="goVideoList(item)">
                        {{ item.type_name }}
                    </div>
                ...
                <!-- 热门搜索词 -->
                <div class="hotText overflow-x-hidden scrollbar" v-if="hotIndex == 0">
                    <Welfare :type="1"  />

                </div>
                <div class="hotText overflow-x-hidden scrollbar" v-if="hotIndex == 2">
                    <Welfare :type="0" />
