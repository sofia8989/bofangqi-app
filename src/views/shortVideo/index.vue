<!-- 短视频页面 -->
<template>
  <div class="home-page h-page text-white overflow-x-hidden scrollbar" @click.stop="popUp = false">
    ...
    <div class="hotNav" v-if="hotIndex == 1 || hotIndex == 0">
      <div class="navName" @click="changeHot(0)" style="color:#fff;">
      ...
      <div class="navName" @click="changeHot(2)">
        <div class="name" :class="hotIndex == 2 ? 'chooseName' : 'name'">茶馆</div>
        <div class="line" :class="hotIndex == 2 ? 'chooseLine' : 'line'"></div>
      </div>
      <div class="navName" @click="changeHot(3)">
        <div class="name" :class="hotIndex == 3 ? 'chooseName' : 'name'">同城</div>
        <div class="line" :class="hotIndex == 3 ? 'chooseLine' : 'line'"></div>
      </div>
      <div class="navName" @click.stop="goPopUp">
        <img src="../../assets/images/shortVideo/more-white.svg" style="margin-top: -5px;" />
      </div>
    </div>
    <div class="hotNav" v-if="hotIndex == 2 || hotIndex == 3" style="color: #000;"
      :style="navIndex == true ? 'background:#fff;' : 'background:#fff;'">
      ...
      <div class="navName" @click.stop="goPopUp">
        <img src="../../assets/images/shortVideo/more-black.svg" style="margin-top: -5px;" />
      </div>
    </div>
    <van-swipe ref="swipeRef" :loop="false" lazy-render class="bg-white"  @change="changeSwipe" :show-indicators="false">
      ...
      <van-swipe-item style="background-color: #000;">
        <shortVideo v-if="hotIndex == 0" :type="hotIndex"
          :style="iPhoneShow ? 'height:calc(100vh - 110px);' : 'height:calc(100vh - 80px);'">
        </shortVideo>
        <van-back-top immediate bottom="80" />
      </van-swipe-item>
      <!-- 最新 -->
      <van-swipe-item style="background-color: #000;">
        <shortVideo v-if="hotIndex == 1" :type="hotIndex"
          :style="iPhoneShow ? 'height:calc(100vh - 110px);' : 'height:calc(100vh - 80px);'">
        </shortVideo>
        <van-back-top immediate bottom="80" />
      </van-swipe-item>
      <!-- 茶馆--> 
      <van-swipe-item>
        <teaHouse v-if="hotIndex == 2" style="margin-top: 100px;"></teaHouse>
      </van-swipe-item>
      <!-- 同城 -->
      <van-swipe-item>
        <actual v-if="hotIndex == 3" style="margin-top: 100px;"></actual>
      </van-swipe-item>
    </van-swipe>

    <div class="popUpBox" v-if="popUp == true">
      <img class="popUp" src="../../assets/images/shortVideo/popUp.png" />
      <div class="popTxt">
        <div class="popBtn" @click="gosend">
          <img src="../../assets/images/shortVideo/sendContent.svg" />
          发帖
        </div>
        <div class="popBtn" @click="goMyCenter">
          <img src="../../assets/images/shortVideo/myCenter.svg" />
          我的中心
        </div>
...
import shortVideo from "@/views/shortVideo/short.vue";
...
import teaHouse from './components/teaHouse.vue'
import actual from '../actual/actual.vue'
